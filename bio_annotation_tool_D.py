...
Người D: Annotate samples 375-499
"""
...
# Config
DATA_FILE = 'data/processed/annotation_sample_D.jsonl'
OUTPUT_FILE = 'data/processed/bio_annotations_D.jsonl'
ANNOTATOR = 'D'
...
if st.session_state.current_idx < total_records:
    ...
    st.success("🎉 Hoàn tát annotation tất cả samples của Người D!")

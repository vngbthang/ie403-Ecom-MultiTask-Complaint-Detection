...
- #1 [92:180] `ví dụ như unit 7 trang 71 của sách phiên bản cũ thì mất luôn cái dòng đối thoại thứ nhất` label=`COMP`
...
- span #1 quá dài (21 tokens >= 15)
- span #2 quá dài (23 tokens >= 15)
- tỉ lệ COMP token > 60% (69.9%)
...
- #0 [0:23] `mình đặt 2 đơn là 10 áo` label=`COMP`
- #1 [24:63] `sao  cửa hàng  giao thiếu 2 đơn là 4 áo` label=`COMP`
- #2 [64:77] `rất thất vọng` label=`COMP`
- #3 [115:120] `thiếu` label=`COMP`
- #4 [121:175] `ko cho kiểm hàng giờ giao thiếu sản phẩm cho khách rồi` label=`COMP`
...
- #0 [41:88] `mình cũng đặt như này ta cái bảng kèm hàng tặng` label=`COMP`
- #1 [97:129] `hàng gửi về vẫn lồn có hàng tặng` label=`COMP`
- #2 [131:144] `hơi thất vọng` label=`COMP`
...
- #0 [51:67] `không thấy có gì` label=`COMP`
- #1 [68:81] `rất thất vọng` label=`COMP`
...
- #0 [0:86] `đéo mẹ game như C vào tạo nv là đứng nếu chplay cho đánh giá âm sao bố cho âm luôn rồi` label=`COMP`

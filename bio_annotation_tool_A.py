...
Người A: Annotate samples 0-124
"""
...
# Config
DATA_FILE = 'data/processed/annotation_sample_A.jsonl'
OUTPUT_FILE = 'data/processed/bio_annotations_A.jsonl'
ANNOTATOR = 'A'
...
if st.session_state.current_idx < total_records:
    ...
    st.success("🎉 Hoàn tát annotation tất cả samples của Người A!")

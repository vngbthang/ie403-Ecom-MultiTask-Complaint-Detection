...
Người B: Annotate samples 125-249
"""
...
# Config
DATA_FILE = 'data/processed/annotation_sample_B.jsonl'
OUTPUT_FILE = 'data/processed/bio_annotations_B.jsonl'
ANNOTATOR = 'B'
...
if st.session_state.current_idx < total_records:
    ...
    st.success("🎉 Hoàn tát annotation tất cả samples của Người B!")
